...
def emit_agent_status(
    ...
    *,
    ...
    Args:
        ...
        session_id: Session ID (defaults to CLAUDE_CODE_SESSION_ID env var).
    ...
    try:
        ...
        if resolved_session_id == "unknown":
            logger.warning(
                "session_id resolved to 'unknown' — CLAUDE_CODE_SESSION_ID env var not set and no --session-id provided"
            )
