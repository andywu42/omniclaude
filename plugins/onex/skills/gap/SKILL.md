...
All audit, fix, and cycle logic executes inside the general-purpose agent. This skill is a thin shell: parse subcommand + args, dispatch to node, render results.
