...
"""Unit tests for lib/core/bus_bootstrap factory."""
...
def test_create_kafka_event_bus_returns_event_bus_kafka() -> None:
    ...
    with patch(
        "omniclaude.lib.core.bus_bootstrap.EventBusKafka", return_value=mock_bus
    ) as mock_cls:
        from omniclaude.lib.core.bus_bootstrap import create_kafka_event_bus
