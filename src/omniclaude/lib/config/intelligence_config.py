...
TOPIC_CODE_ANALYSIS_REQUESTED = "onex.cmd.omniintelligence.code-analysis.v1"  # noqa: arch-topic-naming  # onex-topic-allow: pending contract auto-wiring
TOPIC_CODE_ANALYSIS_COMPLETED = "onex.evt.omniintelligence.code-analysis-completed.v1"  # noqa: arch-topic-naming  # onex-topic-allow: pending contract auto-wiring
TOPIC_CODE_ANALYSIS_FAILED = "onex.evt.omniintelligence.code-analysis-failed.v1"  # noqa: arch-topic-naming  # onex-topic-allow: pending contract auto-wiring
